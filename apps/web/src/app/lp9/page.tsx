...
export const metadata: Metadata = {
  title: "Click Cannabis · Tudo para o seu tratamento com cannabis medicinal",
  description:
    "Consulta médica, receita, importação e acompanhamento. Tudo 100% online, regulamentado pela ANVISA. Primeira consulta R$50.",
  openGraph: {
    title: "Click Cannabis · Tudo para o seu tratamento com cannabis medicinal",
    description:
      "Consulta médica, receita, importação e acompanhamento. Tudo 100% online, regulamentado pela ANVISA.",
...
// depoimento novo (lp9 está em TESTIMONIAL_PATHS).
...
// Depoimentos que não devem aparecer na lp9. "Andre C." não é de um paciente
// em tratamento (é alguém pedindo pra começar), então fica de fora.
...
export default async function LP9Page() {
  const testimonials = await getTestimonials();
  return (
    <div className={`lp9 ${fraunces.variable} ${lexend.variable}`}>
