  ...
  return (
    ...
    >
      ...
      <dialog
        ...
        className="lp13-video w-[calc(100%-2rem)] max-w-[24rem] rounded-[1.25rem] border-0 bg-black p-0 shadow-2xl"
      >
      ...
      <style>{`
        ...
        .lp13-video[open] { opacity: 1; transform: scale(1); }
        .lp13-video::backdrop { background: rgba(0,0,0,0); transition: background 200ms; }
        .lp13-video[open]::backdrop { background: rgba(0,0,0,.88); }
        @starting-style {
          .lp13-video[open] { opacity: 0; transform: scale(.94); }
          .lp13-video[open]::backdrop { background: rgba(0,0,0,0); }
        }
        @media (prefers-reduced-motion: reduce) {
          .lp13-video, .lp13-video[open] { transition: none; }
        }
      `}</style>
    </motion.section>
  );
