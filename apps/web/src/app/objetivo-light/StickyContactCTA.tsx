...
export default function StickyContactCTA() {
  ...
  useEffect(() => {
    const anchor = document.getElementById("objetivo-light-sticky-anchor");
    if (!anchor) return;
  ...
  useEffect(() => {
    const ids = ["objetivo-light-testimonials-wall"];
    const targets = ids
  ...
  return (
    <>
      {/* Estilo .cta-pulse é global da LP (definido em page.tsx), compartilhado com o CTA do hero. */}
      <motion.div
        aria-hidden={!visible}
        ...
        <div className="mx-auto w-full max-w-xl">
          ...
          >
            <p className="text-left text-[1.25rem] leading-snug text-gray-800">
              Atendimento com especialista por apenas{" "}
