...
export default function ScheduleDialog() {
    ...
    const handler = (e: Event) => {
      ...
      setTimeout(() => {
        sendGTMEvent({
          ...
          category: "Lead",
          action: "Click",
          label: `Abrir agendamento (${detail.origem}) - LP17`,
  ...
  const handleSubmit = useCallback(() => {
    ...
    sendGTMEvent({
      ...
      category: "Lead",
      action: "Click",
      label: `Agendar consulta (${originRef.current}) - LP17`,
  ...
  return (
    <>
      <dialog
        ...
        aria-labelledby="lp17-sheet-title"
        className="lp17-sheet w-full max-w-[30rem] border-0 bg-transparent p-0 outline-none"
      >
        <div
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, var(--green-tint) 0%, rgba(255,255,255,0) 100%)",
            }}
          >
            ...
            <h2
              id="lp17-sheet-title"
              className="mt-1.5 text-[1.55rem] font-bold leading-[1.15] tracking-[-0.01em]"
            >
          ...
          <div className="flex-1 overflow-y-auto overscroll-contain px-6 pb-5">
                ...
                return (
                  <motion.button
                    ...
                    style={{
                      ...
                      backgroundColor: isSelected ? "var(--green-tint)" : "#fff",
                      color: isSelected ? "var(--green-600)" : "#374151",
            ...
            <label htmlFor="lp17-nome" className="mt-5 block text-[13.5px] font-medium">
              Seu nome
            </label>
            <input
              id="lp17-nome"
            ...
            {submitted && fallbackUrl ? (
              <p className="mt-2.5 text-center text-[12.5px] leading-snug text-[color:var(--muted)]">
                ...
                <a
                  ...
                  className="font-semibold text-[color:var(--green-600)] underline underline-offset-4"
                >
                  Toque aqui
                </a>
              </p>
      ...
      <style>{`
        ...
        .lp17-sheet[open] { opacity: 1; transform: translateY(0); }
        @starting-style {
          .lp17-sheet[open] { opacity: 0; transform: translateY(24px); }
        }
        @media (min-width: 640px) {
          ...
          .lp17-sheet[open] { transform: scale(1); }
          @starting-style {
            .lp17-sheet[open] { opacity: 0; transform: scale(.96); }
          }
        }
        .lp17-sheet::backdrop {
        ...
        @media (prefers-reduced-motion: reduce) {
          .lp17-sheet, .lp17-sheet[open], .lp17-sheet::backdrop { transition: none; }
        }
      `}</style>
    </>
  );
