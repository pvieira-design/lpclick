          ...
          {STEPS.map((step, index) => {
            ...
            return (
              <div key={step.chip} className="treatment-card-outer w-full">
                ...
                >
                  {/* Frente */}
                  <div className="treatment-card-face flex items-stretch overflow-hidden rounded-3xl bg-[#F4F9F5]">
                  ...
                  {/* Verso */}
                  <div className="treatment-card-face treatment-card-back flex flex-col justify-between rounded-3xl bg-[#F4F9F5] p-5">
                    <div>
