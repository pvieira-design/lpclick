    ...
    <section className="py-12 sm:py-16">
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-5">
        ...
        >
          <motion.span
            variants={fadeUp}
            className="inline-flex w-fit items-center rounded-full px-3 py-1 text-xs font-medium text-[color:var(--green-bright)] sm:col-start-2 sm:row-start-1 sm:justify-self-end sm:text-sm"
            style={{ backgroundColor: "rgba(89,209,114,.12)" }}
          >
            Processos
          </motion.span>
          <motion.h2
            variants={fadeUp}
            className="font-display text-[2rem] leading-[1.02] sm:col-start-1 sm:row-span-2 sm:row-start-1 sm:text-[3rem]"
          >
          ...
          {STEPS.map((step, i) => (
            ...
            >
              <div className="flex items-center justify-between">
                <span
                  className="inline-flex items-center rounded-full px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.08em] text-[color:var(--green-bright)]"
                  style={{ backgroundColor: "rgba(89,209,114,.12)" }}
                >
                  {step.chip}
                </span>
                <span className="font-display text-[2rem] leading-none text-[color:var(--green-bright)]/60">
