...
export default function ScheduleDialog() {
    ...
    const handler = (e: Event) => {
      ...
      setTimeout(() => {
        sendGTMEvent({
          ...
          category: "Lead",
          action: "Click",
          label: `Abrir agendamento (${detail.origem}) - LP15`,
  ...
  const handleSubmit = useCallback(() => {
    ...
    sendGTMEvent({
      ...
      category: "Lead",
      action: "Click",
      label: `Agendar consulta (${originRef.current}) - LP15`,
  ...
  return (
    <>
      <dialog
        ...
        aria-labelledby="lp15-sheet-title"
        className="lp15-sheet w-full max-w-[30rem] border-0 bg-transparent p-0 outline-none"
      >
        <div
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto overscroll-contain px-6 pb-5">
            ...
            <label htmlFor="lp15-nome" className="mt-5 block text-[13.5px] font-medium">
              Seu nome
            </label>
            <input
              id="lp15-nome"
      ...
      <style>{`
        ...
        .lp15-sheet[open] { opacity: 1; transform: translateY(0); }
        @starting-style {
          .lp15-sheet[open] { opacity: 0; transform: translateY(24px); }
        }
        @media (min-width: 640px) {
          ...
          .lp15-sheet[open] { transform: scale(1); }
          @starting-style {
            .lp15-sheet[open] { opacity: 0; transform: scale(.96); }
          }
        }
        .lp15-sheet::backdrop {
        ...
        @media (prefers-reduced-motion: reduce) {
          .lp15-sheet, .lp15-sheet[open], .lp15-sheet::backdrop { transition: none; }
        }
      `}</style>
    </>
  );
