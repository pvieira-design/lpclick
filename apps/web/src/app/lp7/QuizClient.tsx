...
function buildWonWhatsAppUrl(name: string, patologias: string[]) {
  ...
  const text = `Olá, me chamo ${name}.\n\nPatologias selecionadas:\n${list}\n\nAcabei de acertar 10 perguntas no quiz de mitos e verdades da Click Cannabis e quero resgatar minha consulta de acompanhamento gratuita!`;
  ...
  return (
    <>
      <section className="flex min-h-svh flex-col items-center justify-center px-6 py-8 text-center">
        ...
        >
          Teste seus conhecimentos e acertando 10, você ganha uma <strong>consulta de acompanhamento gratuita ao iniciar seu tratamento na Click!</strong>
        </p>
  ...
  return (
    <div className="flex min-h-svh w-full flex-col">
      ...
      <section className="flex flex-1 flex-col items-center justify-center px-5 py-5">
        ...
        >
          <div className="aspect-[16/9] w-full overflow-hidden bg-[#f0f7f1]">
            <img
...
function WonLeadModal({ onClose, mode }: { onClose: () => void; mode: "won" | "lost" }) {
  ...
  function handleSubmit() {
    ...
    sendGTMEvent({
      ...
      category: "Lead",
      action: "Click",
        label: mode === "won" ? "Resgatar consulta - LP7" : "Iniciar tratamento - LP7",
